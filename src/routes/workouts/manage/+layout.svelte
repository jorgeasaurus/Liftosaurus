<script lang="ts">
	...
	let isLoggingExercises = $derived($page.url.pathname.includes('/workouts/manage/exercises'));
...
{:else if editing}
	<div class="mb-2 flex justify-end">
		<Button class="h-8 text-xs" variant="secondary" onclick={cancelEdit}>Cancel edit</Button>
	</div>
{/if}
