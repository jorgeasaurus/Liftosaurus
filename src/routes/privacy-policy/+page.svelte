...
<div class="prose prose-neutral max-w-none dark:prose-invert lg:prose-lg">
	...
	<p>
		...
		use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a
			href="https://www.privacypolicies.com/privacy-policy-generator/">Privacy Policy Generator</a
		>.
	</p>
	...
	<ul>
		...
		<li>
			<p>
				...
				from the Service infrastructure itself (for example, the duration of a page visit, interactions with the interface,
				and navigation patterns recorded during a session).
			</p>
		</li>
		<li>
			<p>
	...
	<p>
		As a fitness application, We collect health and fitness data that You voluntarily provide, including but not limited
		to:
	</p>
	<ul>
		<li><p>Body weight and body composition measurements</p></li>
		<li><p>Exercise logs including exercises performed, sets, repetitions, and weights lifted</p></li>
		<li><p>Workout history and training programs (mesocycles and exercise splits)</p></li>
		<li><p>Physical performance metrics and progression data</p></li>
	</ul>
	<p>
		This health and fitness data is stored securely and used solely to provide the Service's core functionality and to
		personalize Your experience. We do not sell or share this data with third parties for marketing purposes.
	</p>
	...
	<h4>Analytics and Session Recording</h4>
	<p>
		We use PostHog, a third-party product analytics provider, to collect analytics data and record user sessions.
		Session recordings may capture navigation patterns, clicks, and interactions within the app to help Us understand
		how the Service is used and to improve user experience.
	</p>
	<p>
		PostHog is configured to mask all input fields and sensitive content within session recordings. No passwords, health
		data entries, or other sensitive form inputs are captured in recordings.
	</p>
	<p>
		PostHog may collect data including IP addresses, browser type, device information, pages visited, time spent on
		pages, and user interaction events. This data is processed and stored by PostHog in the United States. PostHog's
		privacy policy is available at
		<a href="https://posthog.com/privacy" rel="external nofollow noopener">https://posthog.com/privacy</a>.
	</p>
	...
	<ul>
		...
		<li>
			...
			during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business
			to another company.
		</li>
		<li>
